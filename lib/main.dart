...
//   Future<void> pickImage(bool isMasterImage) async {
//     FilePickerResult? result = await FilePicker.platform.pickFiles(type: FileType.image);
...
//       setState(() {
//         responseMessage =
//             'Score: ${data['score']}, Total Questions: ${data['total_questions']}, Mistakes: ${data['mistakes']}';
//       });
//     } else {
//       setState(() {
//         responseMessage = 'Failed to upload images.';
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Upload Images and Send to API'),
//       ),
//       body: Padding(
...
//             ElevatedButton(
//               onPressed: () => pickImage(true),
//               child: const Text('Upload Master Sheet Image'),
//             ),
//             if (masterImage != null) const Text("Master Sheet Image Selected"),
//             const SizedBox(height: 16),
...
//             ElevatedButton(
//               onPressed: () => pickImage(false), 
//               child: const Text('Upload Student Answer Image'),
//             ),
//             if (studentImage != null) const Text("Student Answer Image Selected"),
...
//             ElevatedButton(
//               onPressed: submitImages, 
//               child: const Text('Submit and Get Score'),
//             ),
//             const SizedBox(height: 16),
